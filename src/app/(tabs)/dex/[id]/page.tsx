        ...
        >
          <p style={{ fontSize: "var(--font-body-sm-size)", color: "var(--soft-ink)" }}>
            {isAiGenerated(species)
              ? "This card was generated by AI, not yet reviewed by a human. "
              : "This species' care numbers were AI-drafted from general knowledge, not checked against a named source. "}
            {species.uncertaintyNote || "Treat the details as a starting point, not gospel."}
          </p>
        </div>
      )}
